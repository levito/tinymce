...
(function(tinymce) {
	...
	tinymce.ThemeManager.requireLangPack('inline');

	tinymce.create('tinymce.themes.InlineTheme', {
		...
		_addToolbars : function(c, o) {
			...
			n = DOM.add(c, 'div', {'class' : 'mceToolbar ' + a, "role":"toolbar"});
		...
		_nodeChanged : function(ed, cm, n, co, ob) {
			...
			if (s.theme_advanced_path && s.theme_advanced_statusbar_location) {
				...
				getParent(function(n) {
					var na = n.nodeName.toLowerCase(), u, ti = '';
	...
	tinymce.ThemeManager.add('inline', tinymce.themes.InlineTheme);
}(tinymce));
